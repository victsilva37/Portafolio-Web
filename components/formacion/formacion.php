                ...
                <?php foreach ($formaciones as $form): ?>
                    <div class="form-item">
                        <div class="form-details">
                            ...
                            <!--FECHAS-->
                            <small>(<strong><?php echo htmlspecialchars($form['fecha_inicio']); ?> - <?php echo htmlspecialchars($form['fecha_final']); ?></strong>)</small>
                        </div>
                        ...
                        <!--LOGROS CON ÍCONOS-->
                        <?php if (!empty($form['logros'])): ?>
                            <div class="form-logros">
                                <?php foreach ($form['logros'] as $logro): ?>
                                    <a href="assets/<?php echo htmlspecialchars($logro['enlace_logro']); ?>" target="_blank">
                                        <img src="assets/<?php echo htmlspecialchars($logro['icono_logro']); ?>" alt="Ícono de <?php echo htmlspecialchars($logro['nombre_logro']); ?>" />
                                    </a>
                                <?php endforeach; ?>
                            </div>
                        <?php endif; ?>
